...
#somando o preço pelo local onde foi feito a compra
...
df_rec_mensal['Mes'] = df_rec_mensal['Data da Compra'].dt.month_name(locale='pt_BR')
...
#vendedores 4 - dataframe vendedores
df_vendedores = pd.DataFrame(df.groupby('Vendedor')['Preço'].agg(['sum', 'count']))
# print(df_vendedores)

# quantidade de vendas por vendedores 
# df_qtd_vendas_vendedores = pd.groupby('Vendedor')[['Produto']].count() o que eu tentei 
